...
To exercise any of these rights, please contact us at **info@tanisiimpex.com** or **+91 91521 21077**.`,
  },
  {
    title: '7. Retention Period',
    content: 'We retain your personal information only as long as necessary to fulfil the purposes described in this policy, or as required by law. Trade inquiry records are typically retained for 7 years in accordance with Indian financial record-keeping requirements.',
  },
  {
    title: '8. Contact Us',
      ...
      <section className="bg-hero-gradient py-24 relative overflow-hidden">
        ...
        <div className="section-container relative z-10 text-center">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <h1 className="font-heading text-white mt-4 mb-4">Privacy Policy</h1>
      ...
      <section className="py-20 bg-white">
        <div className="section-container max-w-4xl">
          <p className="text-gray-600 font-body text-base leading-relaxed mb-10 p-6 bg-gold-50 border border-gold-200 rounded-2xl">
            <strong className="text-navy-800">Tanisi Impex</strong> ("we", "us", or "our") is committed to protecting your privacy.
            This Privacy Policy explains how we collect, use, and safeguard your information when you visit{' '}
            <strong>www.tanisiimpex.com</strong> or engage with our B2B trade services.
          </p>
              ...
              >
                ...
                <div className="text-gray-600 font-body text-base leading-relaxed whitespace-pre-line">
                  {content.split('\n').map((line, j) => {
                    if (line.startsWith('- **')) {
                      ...
                      return (
                        <div key={j} className="flex gap-2 mt-2">
                          ...
                          <span><strong className="text-navy-700">{bold}:</strong>{rest.join(':')}</span>
                        </div>
                      );
                    }
                    ...
                    if (line.startsWith('**') && line.endsWith('**')) return <p key={j} className="font-semibold text-navy-800 mt-3">{line.slice(2, -2)}</p>;
