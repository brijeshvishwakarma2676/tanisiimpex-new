  ...
  if (submitted) {
    return (
      ...
      >
        ...
        <h3 className="font-heading font-semibold text-navy-800 text-2xl mb-2">
          Message Sent!
        </h3>
        <p className="text-gray-500 font-body mb-6">
          We'll get back to you within 24 hours on your email or WhatsApp.
        </p>
        <button
  ...
  return (
    <>
      <SEO
        ...
        description="Contact Tanisi Impex for B2B export inquiries. Call or WhatsApp: +91 91521 21077. Email: tanisiimpex@gmail.com. Office: Mira Road, Mumbai. We respond within 24 hours. Start your import from India today."
        ...
        <div className="section-container relative z-10 text-center">
          ...
          >
            ...
            <p className="text-white/70 text-lg font-body max-w-xl mx-auto">
              We respond to all trade inquiries within 24 hours. For urgent
              matters, chat with us directly on WhatsApp.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="section-container">
          <div className="grid lg:grid-cols-5 gap-10">
            ...
            <div className="lg:col-span-2 space-y-5">
              <h2 className="font-heading text-navy-800 text-2xl mb-6">
                Contact Information
              </h2>
                ...
                >
                  ...
                  <div>
                    ...
                    {href ? (
                      <a
                        href={href}
                        className="text-navy-800 font-body font-semibold text-sm hover:text-gold-500 transition-colors whitespace-pre-line"
                      >
                        {value}
                      </a>
                    ) : (
                      <div className="text-navy-800 font-body font-semibold text-sm whitespace-pre-line">
                        {value}
                      </div>
                    )}
                  </div>
              ...
              {/* WhatsApp CTA */}
              <a
                href="https://wa.me/919152121077?text=Hello%20Tanisi%20Impex%2C%20I%20have%20an%20inquiry."
                target="_blank"
            ...
            <div className="lg:col-span-3">
              <div className="bg-white rounded-3xl shadow-card p-8">
                <h2 className="font-heading text-navy-800 text-2xl mb-2">
                  Send Us a Message
                </h2>
