...
const ORGANIZATION_SCHEMA = {
  ...
  "@type": "Organization",
  name: "Tanisi Impex",
  alternateName: "Tanisi Impex",
  url: BASE_URL,
  logo: `${BASE_URL}/images/logo.png`,
  description:
    "Tanisi Impex is a leading Indian export company based in Mira Road, Mumbai, specializing in premium Basmati rice, spices, fresh vegetables, fruits, FMCG products, and organic goods. Trusted by B2B buyers in 30+ countries.",
  foundingDate: "2009",
  address: {
    "@type": "PostalAddress",
    streetAddress:
  ...
  sameAs: ["https://wa.me/919152121077"],
  knowsAbout: [
    "Basmati Rice Export",
    "Indian Spices Export",
    "Agricultural Commodity Export",
    "FMCG Export from India",
...
export default function SEO({
  ...
  const fullTitle = title
    ? `${title} | ${BRAND}`
    : `${BRAND} — Premium Indian Export Company`;
