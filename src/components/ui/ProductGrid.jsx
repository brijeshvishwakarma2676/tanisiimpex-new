...
import { ArrowRight, Wheat, ShoppingBag, Factory, Leaf, Apple, Flame, Package, Award, Salad } from 'lucide-react';
...
const categoryConfig = {
  ...
  'fresh-vegetables':  { Icon: Salad,       bg: 'from-emerald-900/90 via-emerald-800/60 to-transparent', cardBg: 'bg-gradient-to-br from-emerald-700 to-green-950' },
