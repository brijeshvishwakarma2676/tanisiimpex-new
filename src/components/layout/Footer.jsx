    ...
    <footer className="bg-navy-900 text-white">
      ...
      <div className="section-container py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
              ...
              {socials.map(({ Icon, href, label }) => (
                <a
                  ...
                  className="w-9 h-9 rounded-lg bg-white/8 flex items-center justify-center text-white/60
                             hover:bg-gold-400 hover:text-navy-800 transition-all duration-200"
                >
                  <Icon size={16} />
                </a>
              ))}
          ...
          <div>
            <h3 className="font-heading font-semibold text-lg mb-5 text-white">Quick Links</h3>
          ...
          <div>
            <h3 className="font-heading font-semibold text-lg mb-5 text-white">Product Categories</h3>
            <ul className="space-y-2.5">
            ...
            {/* Certifications */}
            <div className="mt-8">
              <h4 className="font-body font-semibold text-sm text-white mb-3">Certifications & Memberships</h4>
              <div className="flex flex-wrap gap-2">
                {['ISO 9001:2015', 'APEDA', 'FIEO', 'FSSAI', 'Spices Board'].map((cert) => (
                  <span key={cert} className="badge bg-white/10 text-white/70 text-xs">
                    {cert}
                  </span>
                ))}
              </div>
          ...
          <div>
            <h3 className="font-heading font-semibold text-lg mb-5 text-white">Trade Details</h3>
            <div className="space-y-4 font-body text-sm">
              <div>
                <div className="text-white/40 text-xs uppercase tracking-wider mb-1">IEC Code</div>
                <div className="text-white/80">AABCT1234A</div>
              </div>
              <div>
                <div className="text-white/40 text-xs uppercase tracking-wider mb-1">GSTIN</div>
                <div className="text-white/80">27AABCT1234A1Z5</div>
              </div>
              <div>
                <div className="text-white/40 text-xs uppercase tracking-wider mb-1">Ports of Loading</div>
                <div className="text-white/80">JNPT Mumbai | Mundra | Chennai</div>
              </div>
              <div>
                <div className="text-white/40 text-xs uppercase tracking-wider mb-1">Incoterms</div>
                <div className="text-white/80">FOB | CIF | CFR | DDP | EXW</div>
              </div>
              <div>
                <div className="text-white/40 text-xs uppercase tracking-wider mb-1">Payment Terms</div>
                <div className="text-white/80">LC at Sight | TT | DP | DA</div>
              </div>
              <div>
                <div className="text-white/40 text-xs uppercase tracking-wider mb-1">Invoice Currency</div>
